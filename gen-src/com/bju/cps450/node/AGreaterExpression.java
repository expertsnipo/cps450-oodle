...
public final class AGreaterExpression extends PExpression
{
    private PExpression _lhs_;
    private PExpression _rhs_;

    public AGreaterExpression()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAGreaterExpression(this);
    }
